            ...
            <div class="container-fluid">
						...
						<div class="modal-content">
                                ...
                                <form id="cform">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                                    <label for="mentor">Complaint type *</label>
                                                <select name="type" class="form-control" required>
                                                    <option value="">Select complaint type</option>
                                                    <option value=" Request a new device">Request new device</option>
                                                    <option value="Repair">Repair systems</option>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="submit" name="cform" id="cform"class=" cform btn btn-primary">Make complaint</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="table-responsive">
                    <table id="myTable1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <?php
    $query = "SELECT * FROM complaint where id='$s'";
